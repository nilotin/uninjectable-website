      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-14 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {steps.map((step) => (
            <div
              key={step.number}
              className="enterprise-panel-dark rounded-3xl p-6"
            >
              <div className="mb-5 flex items-center justify-between gap-4">
                <span className="font-mono-accent rounded-full border border-cyan-300/20 bg-cyan-300/10 px-3 py-1 text-xs font-semibold text-cyan-300">
                  {step.number}
                </span>
        ...
        <div className="enterprise-panel-dark mt-20 overflow-hidden rounded-[2rem] text-white">
          <div className="console-bar flex items-center justify-between px-5 py-4">
            ...
            <span className="hidden rounded-full border border-red-400/20 bg-red-400/10 px-3 py-1 text-xs font-medium text-red-300 sm:block">
              Blocked
            </span>
          </div>
